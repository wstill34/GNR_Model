...
mu1_se <- c(0.00348, 0.00348, 0.0004725, 0.002835) # Standard error for mu1, fix
mu2 <- c(0.5658, 0.3529, 0.5714, 0.3529)    # Probability of death given hospitalization due to GNR infection
mu2_se <- c(0.05658, 0.03529, 0.05714, 0.03529)    # Standard error for mu2
...
for (sim in 1:n_simulations) {
  ...
  for (age in 1:periods) {
    ...
    if (age == 1) {
      ...
      # Period 2 and beyond: no maternal vaccine effect, so regular hospitalization rates apply
